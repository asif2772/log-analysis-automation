...
public class CustomerController {
	...
	public String home() {
		logger.info("Welcome to CustomerApplication Home");
		return "Welcome to CustomerApplication Home";
	}
	
	@GetMapping(value = "/")
	public String welcomeMsg() {
		logger.info("Welcome to CustomerApplication");
		return "Welcome to CustomerApplication";
	}
